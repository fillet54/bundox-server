System.config({
  ...
  bundles: {
    ...
    "app-build": [
      ...
      "split-pane.html!github:systemjs/plugin-text@0.0.2",
      "split-pane-right.html!github:systemjs/plugin-text@0.0.2",
      "split-pane-left.html!github:systemjs/plugin-text@0.0.2",
      "search-pane.html!github:systemjs/plugin-text@0.0.2",
      "nav-bar.html!github:systemjs/plugin-text@0.0.2",
      "documentation-result-listitem.html!github:systemjs/plugin-text@0.0.2",
      "documentation-pane.html!github:systemjs/plugin-text@0.0.2",
      "document-listitem.html!github:systemjs/plugin-text@0.0.2",
      "bundox.html!github:systemjs/plugin-text@0.0.2",
      "app.html!github:systemjs/plugin-text@0.0.2",
      "type-badge-value-converter",
      "split-pane",
      ...
      "npm:rx@4.0.0/dist/rx",
      "npm:rx@4.0.0/dist/rx.aggregates",
      "npm:rx@4.0.0/dist/rx.async",
      "npm:rx@4.0.0/dist/rx.backpressure",
      "npm:rx@4.0.0/dist/rx.binding",
      "npm:rx@4.0.0/dist/rx.coincidence",
      "npm:rx@4.0.0/dist/rx.experimental",
      "npm:rx@4.0.0/dist/rx.joinpatterns",
      "npm:rx@4.0.0/dist/rx.sorting",
      "npm:rx@4.0.0/dist/rx.virtualtime",
      "npm:rx@4.0.0/dist/rx.testing",
      "npm:rx@4.0.0/dist/rx.time",
      "main",
      "github:twbs/bootstrap@3.3.5",
      "github:twbs/bootstrap@3.3.5/js/bootstrap",
      "highlight-search-value-converter",
      "documentation-result-listitem",
      "documentation-pane",
      "document-listitem",
      "bundox",
      "app"
